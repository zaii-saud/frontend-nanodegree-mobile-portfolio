...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        //get vars definition outside the loop and use index of 0 because they are all the same and the var won't change, also, made a var for the pizza containers to simplify usage
        ...
        var pizzaContLength = pizzaCont.length;
        for (var i = 0; i < pizzaContLength; i++) {
...
document.addEventListener('DOMContentLoaded', function() {
    var cols = 8;
    var s = 256;
    //loopCounter gets the height of the window to use a suitable number to loop on
    var loopCounter = (window.innerHeight / s) * cols;
